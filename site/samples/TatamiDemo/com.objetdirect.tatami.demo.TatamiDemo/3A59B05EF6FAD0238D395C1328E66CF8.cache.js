...
function round_int(x){
  if (x > ($clinit_166() , MAX_VALUE))
    return $clinit_166() , MAX_VALUE;
  if (x < ($clinit_166() , MIN_VALUE))
    return $clinit_166() , MIN_VALUE;
...
function onWindowClosed(){
  while (($clinit_14() , timers).size > 0) {
    throwClassCastExceptionUnlessNull($get_0(($clinit_14() , timers), 0)).nullMethod();
  }
}
...
function fireClosedImpl(){
  ...
  for (it = $iterator_1(closingListeners); $hasNext_1(it);) {
    listener = dynamicCast($next_0(it), 6);
...
function $removeFromParent(this$static){
  if (instanceOf(this$static.parent_0, 13)) {
    dynamicCast(this$static.parent_0, 13).remove_1(this$static);
  }
...
function toArray(){
  return this.toArray_0(initDims_0('[Ljava.lang.Object;', [150], [14], [this.size_0()], null));
}
...
function $addAll(this$static, c){
  var changed, iter;
  iter = $iterator_1(c);
  changed = $hasNext_1(iter);
  while ($hasNext_1(iter)) {
    setImpl(this$static.array, this$static.size++, $next_0(iter));
  }
  return changed;
}
...
function $realizeTable(this$static){
  ...
  rows = initDims_0('[Lcom.google.gwt.user.client.ui.DockPanel$TmpRow;', [153], [39], [rowCount], null);
...
function remove_5(){
  ...
  w = dynamicCast($get_0(this.this$1.widgetList, this.lastIndex), 9);
  $removeFromParent(w);
  this.lastIndex = (-1);
}
...
function $getWidget_0(this$static, elem){
  ...
  return dynamicCast($get_0(this$static.widgetList, index), 9);
}
...
function get_0(id){
  $clinit_72();
  var elem, gwt;
  gwt = dynamicCast($get_1(rootPanels, id), 11);
  if (gwt !== null) {
    return gwt;
  }
  elem = null;
...
function $WidgetCollection(this$static, parent){
  this$static.parent_0 = parent;
  this$static.array = initDims_0('[Lcom.google.gwt.user.client.ui.Widget;', [151], [9], [4], null);
  return this$static;
}
...
function $insert_3(this$static, w, beforeIndex){
  ...
  if (this$static.size == this$static.array.length_0) {
    newArray = initDims_0('[Lcom.google.gwt.user.client.ui.Widget;', [151], [9], [this$static.array.length_0 * 2], null);
...
function $require(this$static, widgetDojo){
  ...
  if (!loaded) {
    ...
    $put(this$static.mapWidget, widgetDojo, ($clinit_157() , TRUE));
  }
  return !loaded;
}
...
function $add_8(this$static, widget, left, top){
  var base;
  base = dynamicCast($get_1(this$static.bases, widget), 30);
  if (base !== null) {
...
function $addAffordance(this$static, widget, ddr, affordances, affordance){
  ...
  result = false;
  widgetSet = dynamicCast($get_1(affordances, affordance), 28);
  if (widgetSet === null) {
...
function $getWidget_1(this$static, e){
  return dynamicCast($get_1(this$static.widgets, wrapJSO(e, Element)), 9);
}

function $getWidgetLeft_0(this$static, widget){
  return $getWidgetLeft(this$static, dynamicCast($get_1(this$static.bases, widget), 9));
}

function $getWidgetTop_0(this$static, widget){
  return $getWidgetTop(this$static, dynamicCast($get_1(this$static.bases, widget), 9));
}
...
function $rebuild(this$static, widget, ddt){
  ...
  {
    ddr = dynamicCast($get_1(this$static.draggables, widget), 29);
    if (ddr !== null) {
  ...
  {
    ddr = dynamicCast($get_1(this$static.targets, widget), 29);
    if (ddr !== null) {
...
function $rebuildAll(this$static){
  ...
  while ($hasNext_4(it)) {
    entry = $next_3(it);
    widget = dynamicCast(entry.getKey(), 9);
    ddr = dynamicCast(entry.getValue_0(), 29);
...
function $removeWidgetFromDragOrDrop(this$static, widget, widgetMap, affordances){
  ...
  ddr = dynamicCast($remove_12(widgetMap, widget), 29);
  length = ddr.affordances.size;
  for (i = 0; i < length; i++) {
...
function $setDraggable(this$static, widget, affordance){
  ...
  if (ddr !== null) {
    ...
    if ($addAffordance(this$static, widget, ddr, this$static.draggableAffordances, affordance)) {
      ...
      ddt = dynamicCast($get_1(this$static.targets, widget), 29);
      if (ddt !== null) {
...
function acceptDrop(e, t){
  ...
  for (i = 0; i < lst.length_0; i++) {
    accept &= dynamicCast(lst[i], 31).acceptDrop_0(draggable, target);
  }
  return accept;
}
...
function dispatchDrop(e, t){
  ...
  lst = this.listeners.toArray();
  for (i = 0; i < lst.length_0; i++) {
    dynamicCast(lst[i], 31).onDrop(draggable, target);
  }
}
...
function remove_14(widget){
  var base, panel;
  base = dynamicCast($get_1(this.bases, widget), 30);
  if (base === null) {
    throw $IllegalStateException(new IllegalStateException(), 'Widget already registered in panel');
  }
   else {
    ...
    panel = dynamicCast($get_1(this.bases, widget), 30);
...
function $buildItems(this$static){
  ...
  for (i = 0; i < this$static.items.size; i++) {
    item = dynamicCast($get_0(this$static.items, i), 32);
    $buildItem(this$static, item);
  }
}
...
function dispatchClick(icon){
  ...
  for (i = 0; i < this.items.size; i++) {
    item = dynamicCast($get_0(this.items, i), 32);
...
function createDojoWidget_7(){
  this.dojoWidget = $createToaster(this, this.messageTopic, this.position_0);
}
...
function $$init_15(this$static){
  this$static.fillColor = ($clinit_125() , BLACK);
  this$static.strokeColor = ($clinit_125() , BLACK);
}
...
function $rotate(this$static, angle){
  ...
  if (angle != 0) {
    ...
    $rotate_0(this$static.position_0, angle, this$static.center);
...
function $scale(this$static, factor){
  var matrixScaled;
  if (factor != 1.0) {
    matrixScaled = getScalingMatrix(factor, this$static.position_0.x_0, this$static.position_0.y_0);
...
function $setLocation(this$static, xCoord, yCoord){
  $setLocation_0(this$static.position_0, xCoord, yCoord);
}
...
function $translate(this$static, xLag, yLag){
  ...
  if (xLag != 0 || yLag != 0) {
    ...
    $translate_0(this$static.position_0, xLag, yLag);
...
function createGfx(surface){
  return $createGfx(this, surface, this.position_0.x_0, this.position_0.y_0, this.radius);
}
...
function createGfx_0(surface){
  return $createEllipse(this, surface, this.position_0.x_0, this.position_0.y_0, this.radiusX, this.radiusY);
}
...
function $attachAllGraphicObjects(this$static){
  ...
  while ($hasNext_1(ite)) {
    graphicObject = dynamicCast($next_0(ite), 33);
...
function doClick(evtSource, x, y){
  ...
  graphicObject = dynamicCast($get_1(this.graphicObjects, wrapJSO(evtSource, JavaScriptObject)), 33);
  ite = $iterator_1($getCurrentListeners(this));
  while ($hasNext_1(ite)) {
    listener = dynamicCast($next_0(ite), 34);
...
function createGfx_1(surface){
  return $createImage(this, surface, this.position_0.x_0, this.position_0.y_0, this.url, this.width_0, this.height_0);
}
...
function $Pattern_0(this$static, url, xCoord, yCoord, width, height){
  $clinit_134();
  this$static.url = url;
  this$static.position_0 = $Point_1(new Point(), xCoord, yCoord);
  this$static.width_0 = width;
  this$static.height_0 = height;
  return this$static;
}
...
function $getGFXPattern(this$static){
  return $createPattern(this$static, this$static.url, this$static.position_0.x_0, this$static.position_0.y_0, this$static.width_0, this$static.height_0);
}
...
function equals_3(object){
  var equals, point;
  equals = false;
  if (instanceOf(object, 35)) {
    point = dynamicCast(object, 35);
...
function createGfx_4(surface){
  return $createGfx_0(this, surface, this.position_0.x_0, this.position_0.y_0, this.width_0, this.height_0);
}
...
function $$init_16(this$static){
  this$static.font = ($clinit_127() , DEFAULT_FONT);
}
...
function createGfx_5(surface){
  return $createGfx_1(this, surface, this.text, this.position_0.x_0, this.position_0.y_0, this.decoration);
}
...
function getBounds_0(){
  ...
  return $Rectangle_0(new Rectangle(), this.position_0.x_0, this.position_0.y_0, width, fontSize);
}
...
function onDrop(draggable, target){
  var couple, dulcinee;
  dulcinee = dynamicCast(target, 37);
...
function $$init_17(this$static){
  this$static.lastPosition = initValues('[I', 154, (-1), [0, 0]);
  this$static.popup = $PopupPanel_0(new PopupPanel(), true);
  this$static.html = $HTML_0(new HTML(), 'X,Y');
  this$static.currentFillColor = ($clinit_125() , WHITE);
  this$static.currentStrokeColor = ($clinit_125() , BLACK);
...
function $initComponents_2(this$static){
  ...
  this$static.strokeSize = initDims_0('[Lcom.google.gwt.user.client.ui.HTML;', [155], [15], [4], null);
...
function $selectObject(this$static, object){
  ...
  $setStroke(this$static.current, ($clinit_125() , RED), 2);
...
function $showProperties(this$static, object){
  ...
  $setWidget_0(panel, 0, 1, $Label_0(new Label(), object.position_0.x_0 + ',' + object.position_0.y_0));
...
function onClick_1(sender){
  ...
  if (this.this$0.current !== null) {
    ...
    if (this.val$url === 'gfx/none.gif') {
      pattern = ($clinit_134() , DEFAULT_PATTERN);
    }
     else {
...
function $clinit_187(){
  ...
  initValues('[Ljava.lang.String;', 152, 1, ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat']);
  initValues('[Ljava.lang.String;', 152, 1, ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec