...
public class TestUtil {
	 ...
	 * @param eventType
	 *            The type for the mouse event without the prefix "on" :
	 ...
	 * @param button
	 *            the button of the mouse to use, 1 for the left button
	 * @param click
	 *            the number of click to do
	 */
	static native void fireMouseEvent(Element e, String eventType, int x,
			int y, int button, int click) /*-{
	 ...
	 *            the y coordinate of the mouse
	 * @param button
	 *            the button of the mouse to use, MOUSE_BUTTON_1,
	 *            MOUSE_BUTTON_2,MOUSE_BUTTON_3
	 * @param nb_click
	 *            the number of click to do
	 * @param task
	 *            the task to run after the event. can be null
	 */
	static public void fireEvent(String event, int x, int y, int button,
			int nb_click, final Task task) {
