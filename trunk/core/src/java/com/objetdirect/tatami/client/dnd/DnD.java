...
public class DnD {
	...
	public static <E extends IDnDElement , S extends IDnDSource<? super E> , T extends IDnDTarget>  void registerBehavior(IDnDBehavior<E, S, T> behavior, Widget source, Widget target) throws BehaviorScopeException{
		...
		T dtarget = null;
		try{
			//TODO Once compiler bug is fixed, remove unnecessary cast to Object
			dsource = (S)(Object)widgetsSourceRegistry.getSource((Panel)source);
		}catch(ClassCastException e){
			try{
				//TODO Once compiler bug is fixed, remove unnecessary cast to Object
				dsource = (S)(Object)treeSourcesRegistry.getSource((Tree)source);	
