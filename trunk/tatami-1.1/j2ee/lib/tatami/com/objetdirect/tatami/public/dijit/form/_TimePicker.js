...
dojo.declare("dijit.form._TimePicker",
	[dijit._Widget, dijit._Templated],
	{
		...
		// See ticket #599
        // A bug #4267 was fixed in IE fieldset tag provides some bugs : 
        // Using the TimePicker? from the tests, works mostly fine in Firefox, but in internet explorer 6, 
        //the graphical selector is extremely wide (approx. 80% of the page) and you are unable to select 
        //any times between full hours. For example, you can select 6:00 and 8:00, but not 6:15, 8:30, etc.
        // to fix the bug we need to replace fieldset by div
		templateString:"<div id=\"widget_${id}\" baseClass=\"dijitTimePicker\" class=\"dijitMenu\"\n><div dojoAttachPoint=\"upArrow\" class=\"dijitButtonNode\">&#9650;</div\n><div dojoAttachPoint=\"timeMenu\" dojoAttachEvent=\"onclick:_onOptionSelected,onmouseover,onmouseout\"\n></div\n><div dojoAttachPoint=\"downArrow\" class=\"dijitButtonNode\">&#9660;</div\n></div>\n",
