...
public class ViewImpl extends AbstractComponent implements View {
	 ...
	 */
	protected boolean checkEventType(Event _e) {
		return (_e instanceof ViewEvent);
	}

	/**
	 * returns true is the listener has the appropriate type
	 */
	protected boolean checkListenerType(MVCComponent _l) {
		return (_l instanceof Controller || _l instanceof View);
	}
}
