...
public abstract class WidgetDnDBehavior implements IDnDBehavior<WidgetDnDElement, WidgetSource, WidgetTarget>{
	...
	/**
	 * It checks whether the target could accept the drop operation. The drop operation can still be refused by the source, or 
	 * when the onDrop event is fired.
	 * This method is called when objects are dragged over the target
	 * 
	 ...
	 * @return
	 */
	public  abstract boolean checkTargetItemAcceptance(Panel target, Panel source, Collection<Widget> draggedWidgets);
	 ...
	 * @return
	 */
	public abstract boolean checkSourceItemAcceptance(Panel target, Panel source, Collection<Widget> draggedWidgets);
	...
	/* (non-Javadoc)
	 * @see com.objetdirect.tatami.client.dnd.IDnDBehavior#checkTargetItemAcceptance(com.objetdirect.tatami.client.dnd.IDnDSource, com.objetdirect.tatami.client.dnd.IDnDTarget, java.util.Collection)
	 */
	public  boolean checkTargetItemAcceptance(
			WidgetSource source, WidgetTarget target,
			Collection<WidgetDnDElement> dndElements) {
			return  checkTargetItemAcceptance(target.getPanel(), source.getPanel(), getWidgetFromWidgetDnDElement(dndElements));
	}
