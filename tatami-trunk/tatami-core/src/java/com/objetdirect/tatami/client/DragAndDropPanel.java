...
public class DragAndDropPanel extends AbsolutePanel {
	...
	public void setDraggable(Widget widget, String affordance) {
		...
		if (ddr!=null) {
			...
			if (addAffordance(widget, ddr, draggableAffordances, affordance)) {
				...
				if (ddt!=null) {// cas particulier pour contourner un bug de YUI : la facult� 
							   // glissante doit toujours �tre d�finie "avant" la facult� cible.
	...
	/**
	 * Reconstruit compl�tement les objets YUI de gestion du Drag and Drop, pour une widget donn�e. Cette
	 * m�thode est n�cessaire pour contourner deux bugs/limitations de YUI :
	 * <ul>
	 * 		<li> YUI ne sait pas retirer isol�ment une facult� � une widget
	 * 		<li> La facult� glissante doit �tre cr��e avant la facult� cible
	 * <ul>
	 * @param widget widget dont les objets de gestion du Drag and Drop doivent �tre reconstruit.
	 * @param ddt un des objets de gestion du Drag and Drop associ� � la widget (c'est � partir de lui que
	 * la fonction unreg de YUI sera appel�e).
	 */
