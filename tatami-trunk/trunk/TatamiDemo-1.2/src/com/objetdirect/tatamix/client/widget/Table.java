...
public class Table extends FocusWidget implements SourcesTableEvents,  HasText, HasHTML {
	...
	private Map<Class<?>, TableCellRenderer> rendererMap; //a map between TableCellRenderer and column classes
	...
	public void sortLocaly(boolean asc, int columnIndex) {
		List<RowSorter> sortedRow = new ArrayList<RowSorter>();
		...
		rowData.clear();
		clearTbody();
		Iterator<RowSorter> ite = sortedRow.iterator();
		int i =0;
   ...
   private class RowSorter implements Comparable<Object> {
	    	...
	    	public int compareTo(Object o) {
			  ...
			  if ( toCompare instanceof Comparable) {
				  result = ((Comparable<Object>)toCompare).compareTo(getIdentifier());
