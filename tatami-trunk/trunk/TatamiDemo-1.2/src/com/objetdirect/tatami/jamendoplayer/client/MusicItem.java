...
public class MusicItem extends SearchTreeItem{
	...
	public MusicItem(JavaScriptObject jsonItem){
		...
		this.setLeafIconClass("musicTreeItem");
		this.setLabelClass("musicTreeItemLabel");
		this.addAttribute("id", JamendoQueryMaker.extractFieldFromOBJ(jsonItem, idKey));
		this.addAttribute("label",JamendoQueryMaker.extractFieldFromOBJ(jsonItem,track_number) + " - " + JamendoQueryMaker.extractFieldFromOBJ(jsonItem, nameKey) );
	}
