...
public class JamendoQueryMaker {
	...
	public static void searchTracksByAlbum(JSONHandler handler , AlbumItem parent) {
		makeJSONRequest("http://api.jamendo.com/get2/track_id+track_name+track_url+track_duration+album_name+album_image+numalbum+artist_id+artist_name/track/jsoncallback/album_track+album_artist/?order=numalbum&album_id="+parent.getValue(Item.idAttribute), handler,  parent);
	}
