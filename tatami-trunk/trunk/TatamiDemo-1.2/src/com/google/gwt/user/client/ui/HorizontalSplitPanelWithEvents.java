 ...
 * </ul>
 */
public final class HorizontalSplitPanelWithEvents extends SplitPanel implements SourcesChangeEvents{

	private ChangeListenerCollection collec = new ChangeListenerCollection();
  ...
  private static class Impl {
    ...
    protected HorizontalSplitPanelWithEvents panel;

    public void init(HorizontalSplitPanelWithEvents panel) {
      this.panel = panel;
    ...
    public void setSplitPositionUsingPixels(int px) {
      ...
      this.panel.setRightWidth(newRightWidth);
...
private int initialThumbPos;
  ...
  public HorizontalSplitPanelWithEvents() {
   ...
   *               thumb 
   */
  public HorizontalSplitPanelWithEvents(HorizontalSplitPanelImages images) {
