...
public class DateUtil {
	...
	public static Date getJavaDate(JavaScriptObject date) {
		...
		return new Date((long)getJSTime(date));
	}
	 ...
	 */
	public static native double getJSTime(JavaScriptObject theDate) 
	/*-{
	 ...
	 */
	public static native JavaScriptObject getJSDate(double time)
	/*-{
