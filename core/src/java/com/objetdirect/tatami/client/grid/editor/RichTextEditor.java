 ...
 *
 */
public class RichTextEditor extends BaseEditor{

	private final String dojoName = "dojox.grid.cells.Editor";
	
	
	public RichTextEditor(boolean hasToolBar){
		addAttribute("editorToolbar",hasToolBar);
	}
	
	public RichTextEditor(boolean hasToolBar,boolean alwaysEditing){
		addAttribute("editorToolbar",hasToolBar);
	}
	...
	public boolean getEditorToolbarVisible(){
		return (Boolean) getAttribute("editorToolbar");
	}
