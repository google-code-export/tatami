...
/**
 * This interface represents a draggable Element.
 * 
 * A draggable Element is supposed to be associated to a DOM Element, to have an ID ,
 * and to be registered to a source
 * 
 * @author rdunklau
 *
 */
