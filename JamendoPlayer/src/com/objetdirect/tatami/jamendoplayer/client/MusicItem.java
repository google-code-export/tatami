...
public class MusicItem extends SearchTreeItem{
	...
	public static final String[] attributesToFill = { idKey , nameKey , url , image , album_name , album_id ,  artist_id , duration , album_image , artist_name , track_number , album_url};
